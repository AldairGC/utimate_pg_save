            ...
            <div class="columns">
                <div class="column is-7">
                    <div class="page-hero__content">
                        <h1 class="page-hero__title">Bolsa de valores</h1>
                        <p>¿Tienes unos ingresos extras y los quieres invertir? 
                            ¿Siempre te ha interesado la bolsa de valores pero 
                            nunca te has atrevido a probarlo? Aquí descubrirás
                            toda la información y más para saber cómo invertir
                            en bolsa. ¡A qué esperas!</p>
                    </div>
                </div>
                <div class="column is-5">
                    <div class="page-hero__image-outer is-hidden-mobile">
                        <figure class="page-hero__image">
                            <img width="800" height="493" src="img/bolsa-p.jpg" class="attachment-full size-full wp-post-image lazyloaded" alt="Criptomonedas" loading="lazy" data-ll-status="loaded">
                            </figure>
                    </div>
                </div>
             </div>
