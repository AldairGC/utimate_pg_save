            ...
            <div class="columns">
                <div class="column is-7">
                    <div class="page-hero__content">
                        <h1 class="page-hero__title">Invertir en criptomonedas</h1>
                        <p>¿Quieres invertir en criptomonedas? Descubre todo lo que 
                        necesitas saber sobre estas monedas virtuales. ¿Es seguro 
                        invertir en ellas? Las respuestas a estas preguntas y más 
                        las encontrarás en este artículo.</p>
                    </div>
                </div>
                <div class="column is-5">
                    <div class="page-hero__image-outer is-hidden-mobile">
                        <figure class="page-hero__image">
                            <img width="800" height="493" src="img/criptopage.webp" class="attachment-full size-full wp-post-image lazyloaded" alt="Criptomonedas" loading="lazy" data-ll-status="loaded">
                            </figure>
                    </div>
                </div>
             </div>
